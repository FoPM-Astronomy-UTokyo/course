...
??? note "Example"
    ...
    fig,axes = plt.figure(3,1,figsize=(8,6))
    axes[0].scatter(x = rs[B], y = cl[B], s=1, c='royalblue', alpha=0.5)
    axes[0].scatter(x = rs[R], y = cl[R], s=5, c='orangered', alpha=0.5)
    axes[0].set_xlabel('redshift')
    axes[0].set_yticks([0,1])
    axes[0].set_yticklabels(['blue','red'])
    axes[1].scatter(x = ab[B], y = cl[B], s=1, c='royalblue', alpha=0.5)
    axes[1].scatter(x = ab[R], y = cl[R], s=5, c='orangered', alpha=0.5)
    axes[1].set_xlabel('$\log(a/b)$')
    axes[1].set_yticks([0,1])
    axes[1].set_yticklabels(['blue','red'])
    axes[2].scatter(x = fD[B], y = cl[B], s=1, c='royalblue', alpha=0.5)
    axes[2].scatter(x = fD[R], y = cl[R], s=5, c='orangered', alpha=0.5)
    axes[2].set_xlabel('frac DeV')
    axes[2].set_yticks([0,1])
    axes[2].set_yticklabels(['blue','red'])
    fig.tight_layout()
    plt.show()
    ```
