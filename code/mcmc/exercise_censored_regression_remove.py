...
fig.tight_layout()
fig.savefig('exercise_censored_regression_remove_autocorr.png')
display_trace(sample, output='exercise_censored_regression_remove_trace.png')
...
fig.tight_layout()
fig.savefig('exercise_censored_regression_remove.png')
plt.show()
