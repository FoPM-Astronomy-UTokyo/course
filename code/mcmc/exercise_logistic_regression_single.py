...
fig.tight_layout()
fig.savefig('exercise_logistic_regression_single_autocorr.png')
display_trace(sample, output='exercise_logistic_regression_single_trace.png')
...
fig.tight_layout()
plt.savefig('exercise_logistic_regression_single.png')
plt.show()
