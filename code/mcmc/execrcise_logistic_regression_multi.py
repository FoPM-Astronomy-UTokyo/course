...
fig.tight_layout()
fig.savefig('execrcise_logistic_regression_multi_autocorr.png')
display_trace(sample, output='execrcise_logistic_regression_multi_trace.png')
...
fig.tight_layout()
plt.savefig('execrcise_logistic_regression_multi.png')
plt.show()
