...
fig.tight_layout()
fig.savefig('execrcise_linear_regression_epsilon_autocorr.png')
display_trace(sample, output='execrcise_linear_regression_epsilon_trace.png')
...
fig.tight_layout()
fig.savefig('execrcise_linear_regression_epsilon.png')
plt.show()
