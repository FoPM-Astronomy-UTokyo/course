...
fig.tight_layout()
fig.savefig('exercise_censored_regression_autocorr.png')
display_trace(sample, output='exercise_censored_regression_trace.png')
...
fig.tight_layout()
fig.savefig('exercise_censored_regression.png')
plt.show()
